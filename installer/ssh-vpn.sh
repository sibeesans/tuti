...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/apih46/tuti/main/skkkk | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
curl -sS https://raw.githubusercontent.com/apih46/tuti/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/apih46/tuti/main/ssh/newudpgw"
...
# install squid
cd
curl -sS "https://raw.githubusercontent.com/apih46/tuti/main/ssh/squid3.conf" | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/squid/squid.conf
...
wget -q https://raw.githubusercontent.com/apih46/tuti/main/ssh/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/apih46/tuti/main/banner/issue.net"
